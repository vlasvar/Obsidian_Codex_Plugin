...
def hot_cache_template() -> str:
    ...
    return (
        ...
        "## Key Recent Facts\n"
        "- Codex can maintain notes across the whole vault and preserve processed originals in `wiki/archive/originals/`.\n\n"
        "## Recent Changes\n"
        "- Core wiki folders, archive, and files are present.\n\n"
        "## Active Threads\n"
        "- None yet.\n"
    )
